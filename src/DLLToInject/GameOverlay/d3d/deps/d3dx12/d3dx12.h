    ...
    _In_reads_ (NumSubresources) const D3D12_SUBRESOURCE_DATA *pSrcData)
{
    ...
    {
        CD3DX12_BOX SrcBox (
            UINT (pLayouts[0].Offset), UINT (pLayouts[0].Offset + pLayouts[0].Footprint.Width));
        ...
        case D3D_ROOT_SIGNATURE_VERSION_1_0:
            switch (pRootSignatureDesc->Version)
            {
                ...
                case D3D_ROOT_SIGNATURE_VERSION_1_1:
                {
                    ...
                    for (UINT n = 0; n < desc_1_1.NumParameters; n++)
                    {
                        ...
                        switch (desc_1_1.pParameters[n].ParameterType)
                        {
                            ...
                            case D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE:
                                ...
                                SIZE_T DescriptorRangesSize =
                                    sizeof (D3D12_DESCRIPTOR_RANGE) * table_1_1.NumDescriptorRanges;
                                void *pDescriptorRanges = (DescriptorRangesSize > 0) ?
                    ...
                    {
                        if (desc_1_0.pParameters[n].ParameterType ==
